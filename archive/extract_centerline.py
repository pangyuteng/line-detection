'''
source https://github.com/pangyuteng/simple-centerline-extraction
'''
...
def extract_centerline(img,start_point,end_point,search_radius=(2,2,1),return_multi_index=True):
    # img: binary mask
